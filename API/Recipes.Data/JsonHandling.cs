...
namespace Recipes.Data
{
    ...
    {
        public static List<Recipe> RecipeFromJson(string json) => JsonConvert.DeserializeObject<List<Recipe>>(json, Recipes.Data.Converter.Settings);
        public static string RecipeToJson(this List<Recipe> self) => JsonConvert.SerializeObject(self, Recipes.Data.Converter.Settings);
